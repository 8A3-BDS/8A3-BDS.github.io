            ...
            <footer class="footer-bg bg-dark container-fluid overflow-hidden"> 
                ...
                <div class="justify-content-md-evenly pb-3 row">
                    <div class="col-md-6 col-xxl-6 data-footer order-last order-md-first order-sm-last order-xxl-first" "">
                        ...
                        <span><?php _e( '@2024 wszelkie prawa zastrzeżone BREATH DESIGN STUDIO by Oliwia Golis', 'fumee' ); ?></span> 
                        <!-- dodać <a> do instagrama Oliwci -->
                    </div>
                    <div class="col-md-4 justify-content-md-end rules-container">
                        <a class="active link-light nav-link" aria-current="page" href="#"><?php _e( 'POLITYKA PRYWATNOŚCI', 'fumee' ); ?></a><span class="separator"> / </span><a class="active link-light nav-link" aria-current="page" href="#"><?php _e( 'REGULAMIN', 'fumee' ); ?></a>
                        <!--  
