...
<section class="container-fluid custom-gradient overflow-hidden pt-3 text-center">
...
<section id="products" style="margin-left: auto; margin-right: auto;" class="container-fluid">
    ...
    <section class="text-center text-lg-start text-secondary">
        <div class="container-fluid overflow-hidden" id="keystone"> 
            ...
            <div class="align-items-center row"> 
                <div class="col-lg-7 order-lg-1 pb-2" data-pg-ia-scene='{"dir":"v","l":[{"a":"fadeIn"}]}' style="z-index: 1;">
        ...
        <section class="contact">
            ...
            <footer class="footer-bg bg-dark container-fluid overflow-hidden"> 
                <div class="row"> 
                    <div class="col-lg-5 col-md formularz ms-auto order-lg-2 order-md-1 py-3 text-center" id="contact">
                    ...
                    <div class="col-lg-6 col-md-6 order-lg-1 order-md-first py-3" id="footer-logo">
                        <img id="footer-img" src="<?php echo get_template_directory_uri(); ?>/assets/logo_form.png" sizes="4000px">
                        <div class="row">
                ...
                <div class="justify-content-md-evenly pb-3 row">
                    <div class="col-md-6 col-xxl-6 data-footer order-last order-md-first order-sm-last order-xxl-first" "">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/breath.png"><span><?php _e( '@2024 wszelkie prawa zastrzeżone BREATH DESIGN STUDIO by Oliwia Golis', 'fumee' ); ?></span> 
                        <!-- dodać <a> do instagrama Oliwci -->
                    </div>
                    <div class="col-md-4 justify-content-md-end rules-container"><a class="active link-light nav-link" aria-current="page" href="#"><?php _e( 'POLITYKA PRYWATNOŚCI', 'fumee' ); ?></a>
                        <span class="separator"> / </span>
                        <a class="active link-light nav-link" aria-current="page" href="#"><?php _e( 'REGULAMIN', 'fumee' ); ?></a>
                        <!--  
