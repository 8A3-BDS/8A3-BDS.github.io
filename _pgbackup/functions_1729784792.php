...
if ( ! function_exists( 'fumee_enqueue_scripts' ) ) :
    ...
    wp_register_script( 'inline-script-1', '', [], '1.0.24', false );
    ...
    wp_enqueue_script( 'fumee-popper', get_template_directory_uri() . '/assets/js/popper.min.js', [], '1.0.24', true);

    wp_deregister_script( 'fumee-bootstrap' );
    wp_enqueue_script( 'fumee-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', [], '1.0.24', true);

    wp_deregister_script( 'fumee-pgia' );
    wp_enqueue_script( 'fumee-pgia', get_template_directory_uri() . '/pgia/lib/pgia.js', [], '1.0.24', true);

    wp_deregister_script( 'fumee-ks_script' );
    wp_enqueue_script( 'fumee-ks_script', get_template_directory_uri() . '/ks_script.js', [], '1.0.24', true);

    wp_deregister_script( 'fumee-salt_script' );
    wp_enqueue_script( 'fumee-salt_script', get_template_directory_uri() . '/salt_script.js', [], '1.0.24', true);
    ...
    wp_enqueue_style( 'fumee-bootstrap', get_template_directory_uri() . '/bootstrap_theme/bootstrap.css', [], '1.0.24', 'all');

    wp_deregister_style( 'fumee-blocks' );
    wp_enqueue_style( 'fumee-blocks', get_template_directory_uri() . '/blocks.css', [], '1.0.24', 'all');

    wp_deregister_style( 'fumee-style' );
    wp_enqueue_style( 'fumee-style', get_bloginfo('stylesheet_url'), [], '1.0.24', 'all');

    wp_deregister_style( 'fumee-satoshi' );
    wp_enqueue_style( 'fumee-satoshi', get_template_directory_uri() . '/satoshi.css', [], '1.0.24', 'all');

    wp_deregister_style( 'fumee-style-1' );
    wp_enqueue_style( 'fumee-style-1', 'https://fonts.cdnfonts.com/css/satoshi', [], '1.0.24', 'all');

    wp_deregister_style( 'fumee-all' );
    wp_enqueue_style( 'fumee-all', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css', [], '1.0.24', 'all');
